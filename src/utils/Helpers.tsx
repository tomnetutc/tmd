...
export const DayPatternOptions: DayPatternOption[] = [
  ...
  {
    label: "H-SR-H",
    value: "Home > Social/Recreation > Home",
    numberTrip: "dp_H_SR_H",
  },
  {
    label: "H-RV-H",
    value: "Home > Religious/Volunteer/Civic > Home",
    numberTrip: "dp_H_RV_H",
  },
  ...
  {
    label: "H-Sh-Sh-H",
    value: "Home > Shopping > Shopping > Home",
    numberTrip: "dp_H_Sh_Sh_H",
  },
  {
    label: "H-W-Sh-H",
    value: "Home > Work > Shopping > Home",
    numberTrip: "dp_H_W_Sh_H",
  },
  {
    label: "H-SR-Sh-H",
    value: "Home > Social/Recreation > Shopping > Home",
    numberTrip: "dp_H_SR_Sh_H",
  },
  {
    label: "H-Sh-H-SR-H",
    value: "Home > Shopping > Home > Social/Recreation > Home",
    numberTrip: "dp_H_Sh_H_SR_H",
  },
  { label: "H-H", value: "Home > Home", numberTrip: "dp_H_H" },
  {
    label: "H-W-H-SR-H",
    value: "Home > Work > Home > Social/Recreation > Home",
    numberTrip: "dp_H_W_H_SR_H",
  },
  { label: "H-H-H", value: "Home > Home > Home", numberTrip: "dp_H_H_H" },
  {
    label: "H-E-Sh-H",
    value: "Home > Errands > Shopping > Home",
    numberTrip: "dp_H_E_Sh_H",
  },
  {
    label: "H-W-H-W-H",
    value: "Home > Work > Home > Work > Home",
    numberTrip: "dp_H_W_H_W_H",
  },
  {
    label: "H-Sh-H-Sh-H",
    value: "Home > Shopping > Home > Shopping > Home",
    numberTrip: "dp_H_Sh_H_Sh_H",
  },
  {
    label: "H-W-H-Sh-H",
    value: "Home > Work > Home > Shopping > Home",
    numberTrip: "dp_H_W_H_Sh_H",
  },
  {
    label: "H-W-D-W-H",
    value: "Home > Work > Dining > Work > Home",
    numberTrip: "dp_H_W_D_W_H",
  },
  {
    label: "H-W-W-H",
    value: "Home > Work > Work > Home",
    numberTrip: "dp_H_W_W_H",
  },
  { label: "H-S-H", value: "Home > Education > Home", numberTrip: "dp_H_S_H" },
  {
    label: "H-SR-H-SR-H",
    value: "Home > Social/Recreation > Home > Social/Recreation > Home",
    numberTrip: "dp_H_SR_H_SR_H",
  },
  {
    label: "H-SR-SR-H",
    value: "Home > Social/Recreation > Social/Recreation > Home",
    numberTrip: "dp_H_SR_SR_H",
  },
  {
    label: "H-RV-Sh-H",
    value: "Home > Religious/Volunteer/Civic > Shopping > Home",
    numberTrip: "dp_H_RV_Sh_H",
  },
  {
    label: "H-Sh-Sh-Sh-H",
    value: "Home > Shopping > Shopping > Shopping > Home",
    numberTrip: "dp_H_Sh_Sh_Sh_H",
  },
  {
    label: "H-C-H-C-H",
    value: "Home > Care > Home > Care > Home",
    numberTrip: "dp_H_C_H_C_H",
  },
  {
    label: "H-Sh-SR-H",
    value: "Home > Shopping > Social/Recreation > Home",
    numberTrip: "dp_H_Sh_SR_H",
  },
  {
    label: "H-D-Sh-H",
    value: "Home > Dining > Shopping > Home",
    numberTrip: "dp_H_D_Sh_H",
  },
  {
    label: "H-W-SR-H",
    value: "Home > Work > Social/Recreation > Home",
    numberTrip: "dp_H_W_SR_H",
  },
  {
    label: "H-RV-D-H",
    value: "Home > Religious/Volunteer/Civic > Dining > Home",
    numberTrip: "dp_H_RV_D_H",
  },
...
export const fetchAndFilterData = async (
  ...
  try {
    ...
    const filteredData = data.filter(
      filterCriteria(selectedOptions, year, weekOption, filterUnemployed)
    );
    return filteredData;
  } catch (error) {
...
export const getTotalRowsForYear = async (
  dataProvider: { loadData: () => Promise<any[]> },
  year: string
) => {
  try {
...
export const fetchAndFilterDataForBtwYearAnalysis = async (
  dataProvider: { loadData: () => Promise<any[]> },
  selectedOptions: Option[],
  weekOption: weekOption,
  toggleState: boolean,
  ...
  try {
    const data = await dataProvider.loadData();
    return data.filter(
      filterCriteria(selectedOptions, "", weekOption, filterUnemployed)
    );
  } catch (error) {
    console.error(
      "Error fetching and filtering data for between year analysis:",
      error
    );
    return [];
  }
...
export const TripLevelDataFilter = async (
  ...
  try {
    ...
    const filteredData = data.filter((row) => {
      ...
      const groupCheck = Object.values(groupedOptions).every(
        (group: Option[]) => {
          return group.some((option) => {
            const column = option.id;
            const value = option.val;
    ...
    console.error(
      "Error fetching and filtering data for trip level analysis:",
      error
    );
    return [];
  }
