import {TripChartDataProps, CountObj, DataRow, SampleSizeTableProps, TripPurposeOption } from "../../Types"
import { TravelModeOptions, TripLevelTripPurposeOptions, TripLevelTravelModeOptions } from "../../utils/Helpers";
...
export const prepareVerticalChartData = (filteredData: DataRow[], analysisYear: string, optionValues: TripPurposeOption[], includeDecember: boolean | undefined, activeOption: string): {
    ...
    const labelModeDistribution = TripLevelTravelModeOptions.map(option => `${option.label}`);
    const mapModeToIndex = TripLevelTravelModeOptions.reduce((labelModeDistribution, option, index) => {
